...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://postgres:postgres@localhost:5432/myspendee")
...
def init_db():
    from models import Transaction, Statement, Loan, LoanPayment  # noqa: F401
